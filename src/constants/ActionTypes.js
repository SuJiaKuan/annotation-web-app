...
export const GET_LABELED_FRAME_LIST_REQUEST = 'GET_LABELED_FRAME_LIST_REQUEST'
export const GET_LABELED_FRAME_LIST_SUCCESS = 'GET_LABELED_FRAME_LIST_SUCCESS'
export const GET_LABELED_FRAME_LIST_FAIL = 'GET_LABELED_FRAME_LIST_FAIL'
export const GO_PREV_LABELED_FRAME = 'GO_PREV_LABELED_FRAME'
export const GO_NEXT_LABELED_FRAME = 'GO_NEXT_LABELED_FRAME'
